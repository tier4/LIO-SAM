...
PointType pointAssociateToMap(const Eigen::Affine3f& transPointAssociateToMap,
                              const PointType& pi) {
    ...
    for (int i = 0; i < laserCloudCornerLastDSNum; i++) {
      ...
      if (pointSearchSqDis[4] < 1.0) {
        ...
        if (matD1.at<float>(0, 0) > 3 * matD1.at<float>(0, 1)) {
          ...
          float a012 = sqrt(((p0(0) - p1(0)) * (p0(1) - p2(1)) - (p0(0) - p2(0)) * (p0(1) - p1(1))) *
                            ((p0(0) - p1(0)) * (p0(1) - p2(1)) - (p0(0) - p2(0)) * (p0(1) - p1(1))) +
                            ((p0(0) - p1(0)) * (p0(2) - p2(2)) - (p0(0) - p2(0)) * (p0(2) - p1(2))) *
                            ((p0(0) - p1(0)) * (p0(2) - p2(2)) - (p0(0) - p2(0)) * (p0(2) - p1(2))) +
                            ((p0(1) - p1(1)) * (p0(2) - p2(2)) - (p0(1) - p2(1)) * (p0(2) - p1(2))) *
                            ((p0(1) - p1(1)) * (p0(2) - p2(2)) - (p0(1) - p2(1)) * (p0(2) - p1(2))));

          float l12 = sqrt((p1(0) - p2(0))*(p1(0) - p2(0)) +
                           (p1(1) - p2(1))*(p1(1) - p2(1)) +
                           (p1(2) - p2(2))*(p1(2) - p2(2)));

          float la = +((p1(1) - p2(1)) * ((p0(0) - p1(0)) * (p0(1) - p2(1)) - (p0(0) - p2(0)) * (p0(1) - p1(1))) +
                       (p1(2) - p2(2)) * ((p0(0) - p1(0)) * (p0(2) - p2(2)) - (p0(0) - p2(0)) * (p0(2) - p1(2)))) / a012 / l12;

          float lb = -((p1(0) - p2(0)) * ((p0(0) - p1(0)) * (p0(1) - p2(1)) - (p0(0) - p2(0)) * (p0(1) - p1(1))) -
                       (p1(2) - p2(2)) * ((p0(1) - p1(1)) * (p0(2) - p2(2)) - (p0(1) - p2(1)) * (p0(2) - p1(2)))) / a012 / l12;

          float lc = -((p1(0) - p2(0)) * ((p0(0) - p1(0)) * (p0(2) - p2(2)) - (p0(0) - p2(0)) * (p0(2) - p1(2))) +
                       (p1(1) - p2(1)) * ((p0(1) - p1(1)) * (p0(2) - p2(2)) - (p0(1) - p2(1)) * (p0(2) - p1(2)))) / a012 / l12;
